...
public class ExecuteSQLFile {
    ...
    public static void resetDatabase(String fileUrl) throws SQLException {
        String s = new String();
        ...
        try {
            ...
            Connection c = ExecuteSQLFile.getConnection();
    ...
    public static void main(String[] args) {
        try {
            resetDatabase("I:\\dist\\backups\\1449864576414.sql");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
